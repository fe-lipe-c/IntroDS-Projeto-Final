...
def extractPDF_type1(path,ano):
    ...
    if ano=='2019':
        ...
        ret=text.split('CÂMARA')[1].split('Montagem')[0]
        retirar='CÂMARA'+ret+'Montagem'
        text=text.replace(retirar,'')
...
def agregar_dict(ano,mydir):
    rootPath=mydir.replace('\Scripts','')+'\\Data2'
    arq=[]
    dicionarios=[]
    ...
    for file in arq:
        ...
        sessao_dict=extractPDF_type1(filename,ano)
